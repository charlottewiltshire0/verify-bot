...
class VerifyButton(disnake.ui.View):
    ...
    async def verify_accept(self, interaction: disnake.CommandInteraction):
    ...
    async def verify_reject(self, interaction: disnake.CommandInteraction):
        self.value = False
    ...
    async def verify_cancel(self, interaction: disnake.CommandInteraction):
        self.value = None
